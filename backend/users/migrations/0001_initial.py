    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commerçant', models.BooleanField(blank=True, default=False)),
                ...
                ('logo_vendeur', models.ImageField(blank=True, null=True, upload_to='vendeur_logos/')),
                ('image_vendeur', models.ImageField(blank=True, null=True, upload_to='vendeur_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='production_user_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='production_user_permissions', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
                'verbose_name_plural': 'users',
